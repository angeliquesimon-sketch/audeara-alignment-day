...
tab_submit, tab_team, tab_play = st.tabs([
    '🧭 Submit your results', '🎨 Team map', '🤝 Play Nice',
])
...
def _scenario_view():
    ...
    st.markdown(
        ...
        f'<div style="font-family:\'roc-grotesk\',sans-serif;font-feature-settings:\'ss01\' 1,\'ss02\' 1;font-size:1.2em;font-weight:700;color:#111;margin-bottom:6px;">{sc["title"]}</div>'
...
# ── Play Nice participant fragment ────────────────────────────────────────────────
