    ...
    if stage == 'hidden':
        ...
        if stage_idx >= 1:
            ...
            _engine_cards = ''.join([
                ...
                f'<div style="font-family:\'roc-grotesk\',sans-serif;font-feature-settings:\'ss01\' 1,\'ss02\' 1;font-weight:500;font-size:1.15em;color:{FOREST};margin-bottom:2px;">{e["title"]}</div>'
        ...
        if stage_idx >= 3:
            ...
            _choice_cards = ''.join([
                ...
                f'<div style="font-family:\'roc-grotesk\',sans-serif;font-feature-settings:\'ss01\' 1,\'ss02\' 1;font-weight:500;font-size:1.15em;color:#1a1a1a;margin-bottom:6px;">{c["title"]}</div>'
                + (
