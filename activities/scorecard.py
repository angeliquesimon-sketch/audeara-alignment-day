...
st.markdown(
    f'<div style="font-family:\'roc-grotesk\',sans-serif;font-weight:700;font-size:1.3em;color:{WINE};margin-bottom:4px;">'
    ...
    # ── Per-choice sections ────────────────────────────────────────────────────
        ...
        for idx, choice in enumerate(choices):
            ...
            st.markdown(
                ...
                f'<div style="font-family:\'roc-grotesk\',sans-serif;font-weight:700;font-size:1.0em;color:#1a1a1a;">{choice["title"]}</div>'
                f'</div>',
                unsafe_allow_html=True,
            )
